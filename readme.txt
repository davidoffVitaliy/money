Эксперемент - архитектура mvc но без классов, написано процедурным стилем. Что из этого получиться? будут ли какие либо проблемы в будущем?

Проект в начальной стадии разработки
MVC - без классов. написан процедурным стилем. Основная политика - минимум кода.
